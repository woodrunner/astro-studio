  ...
  return `
    <nav style="position:sticky;top:0;z-index:50;display:flex;justify-content:space-between;align-items:center;padding:1rem 3rem;background:${c.bg};border-bottom:1px solid ${c.border};">
      ...
      <ul style="display:flex;gap:2.5rem;list-style:none;align-items:center;">
        ...
        `).join('')}
        <li>
          <a style="font-family:${f.h};font-size:0.8rem;font-weight:800;letter-spacing:0.1em;text-transform:uppercase;background:var(--accent);color:#fff;padding:0.6rem 1.5rem;text-decoration:none;">
            Start project
          </a>
        </li>
      </ul>
...
export function hero({ c, f }) {
  const mutedText = c.bg === '#0E0E0E' || c.bg === '#0A0A0A'
  ...
  return `
    <section style="min-height:92vh;background:${c.bg};display:grid;grid-template-columns:1fr 280px;overflow:hidden;position:relative;">
      ...
      <div style="padding:4rem 3rem;display:flex;flex-direction:column;justify-content:space-between;">
        <p style="font-family:${f.mo};font-size:0.65rem;letter-spacing:0.25em;color:var(--accent);text-transform:uppercase;">
        ...
        <div>
          <h1 style="font-family:${f.h};font-size:clamp(4rem,10vw,9rem);font-weight:900;line-height:0.9;letter-spacing:-0.01em;text-transform:uppercase;color:${c.text};">
            ...
            DIGITAL<br/>
            <span style="color:${mutedText}">THINGS.</span>
          </h1>
          <div style="display:flex;gap:1rem;margin-top:3rem;">
            <a style="font-family:${f.h};font-size:0.85rem;font-weight:800;letter-spacing:0.12em;text-transform:uppercase;background:var(--accent);color:#fff;padding:1rem 2.5rem;text-decoration:none;">
              View our work →
            </a>
            <a style="font-family:${f.h};font-size:0.85rem;font-weight:700;letter-spacing:0.12em;text-transform:uppercase;border:1px solid ${c.border};color:${c.muted};padding:1rem 2rem;text-decoration:none;">
              About us
            </a>
          </div>
        </div>
      ...
      <div style="background:var(--accent);display:flex;flex-direction:column;justify-content:flex-end;padding:2rem;position:relative;overflow:hidden;">
        ...
        <p style="font-family:${f.h};font-size:3rem;font-weight:900;line-height:1;color:rgba(0,0,0,0.2);text-transform:uppercase;letter-spacing:-0.02em;">
          ${YEAR}
        </p>
  ...
  return `
    <section style="background:${c.bg};padding:4rem 0;border-top:1px solid ${c.border};">
      <div style="padding:0 3rem 2rem;display:flex;justify-content:space-between;align-items:flex-end;">
        <h2 style="font-family:${f.h};font-size:3rem;font-weight:900;text-transform:uppercase;color:${c.text};">
