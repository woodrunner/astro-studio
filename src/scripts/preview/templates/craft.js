...
export function nav({ c, f }) {
  const links = ['Home', 'Diensten', 'Over mij', 'Contact'];
  ...
  return `
    <nav style="background:${c.surface};border-bottom:1px solid ${c.border};">
      <div style="display:flex;justify-content:space-between;align-items:center;padding:1rem 3rem;">
        ...
        <a style="background:var(--accent);color:#fff;padding:0.55rem 1.25rem;font-size:0.8rem;border-radius:999px;text-decoration:none;font-weight:500;">
          Contacteer mij
        </a>
      </div>
    </nav>`;
    ...
    <section style="background:${c.bg};padding:5rem 3rem 4rem;">
      <div style="display:grid;grid-template-columns:1fr 1fr;gap:4rem;align-items:center;max-width:900px;margin:0 auto;">
        ...
        <div style="position:relative;">
          <div style="width:100%;aspect-ratio:3/4;background:linear-gradient(160deg,var(--accent-33),var(--accent-88));border-radius:16px;display:flex;align-items:center;justify-content:center;overflow:hidden;">
        ...
        <div>
          <p style="font-family:'Space Mono',monospace;font-size:0.7rem;color:var(--accent);letter-spacing:0.2em;text-transform:uppercase;margin-bottom:1.5rem;">
            Hallo, ik ben
          </p>
          ...
          <p style="font-size:1rem;color:${c.muted};line-height:1.8;margin-bottom:2rem;">
